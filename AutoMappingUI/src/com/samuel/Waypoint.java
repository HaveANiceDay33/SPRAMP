...
public class Waypoint {
	...
	public float sizeX;
	public float sizeY;
	public Waypoint(float x, float y, float size, Color color, String type, String action, 
			float distance, double angleOffset, double origAngle, float sizeX, float sizeY) {
		this.x = x;
		this.y = y;
		this.size = size;
		this.color = color;
